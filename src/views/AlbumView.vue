    ...
    <div v-if="album" class="album-content">
      ...
      <div v-if="multiSelectMode && selected.size > 0" class="batch-toolbar">
        ...
        <span class="batch-toolbar__actions">
          ...
          <el-button size="small" @click="batchAddQueue(album.tracks.filter(t => selected.has(t.path)))">添加到队尾</el-button>
          <el-button size="small" @click="batchAddQueueNext(album.tracks.filter(t => selected.has(t.path)))">添加到下一曲</el-button>
